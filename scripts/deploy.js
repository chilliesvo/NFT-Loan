...
async function main() {
    ...
    //** NFTFactory */
    const tokenBoundAccount = await deployProxyAndLogger(contractFactories.TokenBoundAccount);
    verifyArguments.tokenBoundAccount = tokenBoundAccount.address;
    verifyArguments.tokenBoundAccountVerify = tokenBoundAccount.addressVerify;
